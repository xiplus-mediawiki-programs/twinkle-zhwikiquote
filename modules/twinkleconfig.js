...
Twinkle.config.commonSets = {
	csdCriteria: {
		db: wgULS('自定义理由', '自訂理由'),
		g1: 'G1', g2: 'G2', g3: 'G3', g4: 'G4', g5: 'G5', g7: 'G7', g9: 'G9', g10: 'G10', g11: 'G11', g13: 'G13',
		o1: 'O1', o2: 'O2', o3: 'O3', o4: 'O4',
		r1: 'R1', r2: 'R2', r3: 'R3', r4: 'R4'
	},
	csdCriteriaDisplayOrder: [
		'db',
		'g1', 'g2', 'g3', 'g4', 'g5', 'g7', 'g9', 'g10', 'g11', 'g13',
		'o1', 'o2', 'o3', 'o4',
		'r1', 'r2', 'r3', 'r4'
	],
...
Twinkle.config.sections = [
	{
		...
		// Text to be appended to the edit summary of edits made using Twinkle
			...
			// Twinkle.config.disabledModules (array)
			{
				...
				type: 'set',
				setValues: { speedy: wgULS('速删', '速刪'), xfd: wgULS('提删', '提刪'), diff: wgULS('差异', '差異'), 'fluff': '回退' }
			}
		]
	},
